...
import { CommonModule } from '@angular/common'; // Importar para ngIf, ngFor, ngStyle
import { ReactiveFormsModule } from '@angular/forms'; // Importar para formGroup, formControlName
import { MaterialModule } from 'src/app/material.module';

@Component({
  selector: 'app-tbl-bootstrap',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, RouterModule,MaterialModule], // Agregar CommonModule y ReactiveFormsModule
